...
INNER JOIN eventosenruta
ON eventos.idevento = eventosenruta.idevento
INNER JOIN rutas
ON rutas.idruta = eventosenruta.idruta
WHERE rutas.idruta = '$rutaEnviada'";
...
echo '{"eventos":'. json_encode($resultados) .'}'; 
?>